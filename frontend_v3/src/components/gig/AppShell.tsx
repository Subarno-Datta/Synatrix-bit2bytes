  ...
  return (
    <div className="relative min-h-screen">
      ...
      >
        ...
        >
          ...
          <AnimatePresence>
            {open ? (
              ...
              >
                <p className="font-heading text-[15px] tracking-tight">RideRight</p>
            ...
            return (
              ...
              >
                <Link
                  to={item.to}
                  className={cn(
                    "group relative flex items-center gap-3 rounded-2xl px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors duration-300 hover:text-foreground",
                ...
                >
                  {active ? (
                    <motion.span
                      layoutId="nav-active"
                      className="absolute inset-0 rounded-2xl border border-primary/25 bg-white/[0.06]"
                      style={{ boxShadow: "0 14px 40px -22px #3B82F6, inset 0 1px 0 0 oklch(1 0 0 / 8%)" }}
        ...
        <button
          onClick={() => setOpen((v) => !v)}
          className="flex items-center gap-3 rounded-2xl px-3 py-2.5 text-sm text-muted-foreground transition-all duration-300 hover:bg-white/[0.06] hover:text-foreground"
        >
      ...
      >
        <motion.header
          ...
          className="sticky top-0 z-30 flex items-center gap-3 border-b border-border/60 bg-[oklch(0.14_0.036_267/0.65)] px-5 py-4 backdrop-blur-2xl md:px-10"
        >
          <button
            onClick={() => setPaletteOpen(true)}
            className="group flex flex-1 items-center gap-2 rounded-2xl border border-border bg-white/[0.04] px-3.5 py-2.5 text-sm text-muted-foreground transition-all duration-300 hover:border-primary/40 hover:bg-white/[0.06] hover:shadow-[0_0_0_1px_oklch(0.623_0.188_259.8/0.15),0_12px_30px_-18px_oklch(0.623_0.188_259.8/0.5)] md:max-w-md"
          >
