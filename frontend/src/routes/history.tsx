        ...
        <div className="flex flex-wrap gap-2">
          {filters.map((f) => (
            <motion.button
              ...
              className={cn(
                "rounded-full border border-border bg-white/[0.04] px-4 py-2 text-xs font-medium text-muted-foreground transition-colors hover:text-foreground",
