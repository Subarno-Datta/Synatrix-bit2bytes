    ...
    <div className="space-y-16">
      <section className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
        ...
        <div className="relative">
          {/* Decorative rider — desktop only, glows behind the frosted score card */}
          <div
            aria-hidden
            className="pointer-events-none absolute inset-x-0 bottom-0 z-0 hidden justify-end xl:flex"
          >
            <div className="relative -mb-5 -mr-1 2xl:-mr-6">
              <div
                ...
                style={{
                  ...
                  animation: "shield-glow-pulse 4.5s ease-in-out infinite",
                }}
              />
              <img
                src="/hero-rider.png"
                alt="RideRight rider checking live navigation, shield emblem lit on the helmet"
                className="relative h-[38vh] max-h-[360px] min-h-[240px] w-auto object-contain"
                style={{
                  animation: "rider-float 5s ease-in-out infinite",
